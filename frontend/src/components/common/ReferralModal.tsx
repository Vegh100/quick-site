    ...
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent className="max-w-md">
        <DialogHeader>
          ...
          <DialogDescription>
            Oszd meg a Qvick-et más vállalkozásokkal és szerezz jutalmat, ha
            csatlakoznak
          </DialogDescription>
        </DialogHeader>
        ...
        <div className="space-y-6">
          <div className="bg-gradient-to-br from-primary/10 via-accent/10 to-secondary/10 p-6 rounded-lg text-center">
            ...
            <p className="text-sm text-muted-foreground">
              Hívj meg egy vállalkozást a Qvick-re, és mindketten kaptok 1
              ingyenes hónapot a regisztrációkor
            </p>
          </div>
